...
a1 <- ggplot(data, aes(y=OC, x=LU1_Desc)) +
  ...
  labs(y="OC", x = "")+ 
  ggtitle("OC | land cover classes (n = 20,304)")+
  theme(plot.title = element_text(hjust = 0.5))+ theme(legend.text=element_text(size=rel(1.2)))+
  stat_compare_means(comparisons = cmpr, tip.length=0, label.y = c(600, 650),
                     label = "p.signif", 
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("****", "***", "**", "*", "ns")))+
  stat_compare_means(comparisons = cmpr1, tip.length=0, label.y = 740,
                     label = "p.signif", 
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("****", "***", "**", "*", "ns")))
...
a2 <- ggplot(data, aes(y=P, x=LU1_Desc)) +
  ...
  theme(legend.text = element_text(size = 10),legend.title = element_text(size = 12))+
  labs(y="P", x = "")+ 
  ggtitle("P | land cover classes (n = 20,304)")+
  theme(plot.title = element_text(hjust = 0.5))+ theme(legend.text=element_text(size=rel(1.2)))+
  stat_compare_means(comparisons = cmpr, tip.length=0, label.y = c(1100, 1180),
                     label = "p.signif", 
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("****", "***", "**", "*", "ns")))+
  stat_compare_means(comparisons = cmpr1, tip.length=0, label.y = 1200,
                     label = "p.signif", 
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("****", "***", "**", "*", "ns")))
...
a3 <- ggplot(data, aes(y=N, x=LU1_Desc)) +
  ...
  theme(legend.text = element_text(size = 10),legend.title = element_text(size = 12))+
  labs(y="N", x = "")+ 
  ggtitle("N | land cover classes (n = 20,304)")+
  theme(plot.title = element_text(hjust = 0.5))+ theme(legend.text=element_text(size=rel(1.2)))+
  stat_compare_means(comparisons = cmpr, tip.length=0, label.y = c(40, 45),
                     label = "p.signif", 
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("****", "***", "**", "*", "ns")))+
  stat_compare_means(comparisons = cmpr1, tip.length=0, label.y = 55,
                     label = "p.signif", 
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("****", "***", "**", "*", "ns")))
...
a4 <- ggplot(data, aes(y=K, x=LU1_Desc)) +
  ...
  theme(legend.text = element_text(size = 10),legend.title = element_text(size = 12))+
  labs(y="K", x = "")+ 
  ggtitle("K | land cover classes (n = 20,304)")+
  theme(plot.title = element_text(hjust = 0.5))+ theme(legend.text=element_text(size=rel(1.2)))+
  stat_compare_means(comparisons = cmpr, tip.length=0, label.y = c(10000, 10800),
                     label = "p.signif", 
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("****", "***", "**", "*", "ns")))+
  stat_compare_means(comparisons = cmpr1, tip.length=0, label.y = 11600,
                     label = "p.signif", 
                     symnum.args = list(cutpoints = c(0, 0.0001, 0.001, 0.01, 0.05, 1), 
                                        symbols = c("****", "***", "**", "*", "ns")))
...
ggsave(plot = fig,
       filename = "Level_jitter_plot_Europe.tiff",
       device = "tiff", 
       path = "./",
       width = 12, 
       height = 8,  
